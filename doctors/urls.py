...
from .views import  doctor_dashboard, profile, doctor_blogs, search_blogs, blogs_category, view_blog, post_comment, doctor_drafts, upload_blog, doctor_myblogs, view_appointments, book_appointment_doctor
...
urlpatterns = [
  ...
  path('book_appointment/', book_appointment_doctor, name='doctor_book_appointment'),
]
